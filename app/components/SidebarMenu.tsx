    ...
    <div className='flex '>
        ...
        <div className='p-6 w-1/2 h-screen bg-white z-20 fixed top 0 -left-96 lg:w-60 lg:left-0 peer-focus:left-0 peer:transition ease-out delay-150 duration-200'>
            ...
            <div className='my-4 border-b border-gray-100 pb-4'>
                ...
                <Link href={'components/profile'} className='flex mb-2 justify-start items-center gap-4 px-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadod-lg m-auto'>
                    {/* need icones */}
